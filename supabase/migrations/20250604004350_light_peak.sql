/*
  ...
  1. Changes
    - Enable unaccent extension for better Spanish text search
    - Add search_vector column for full-text search
    - Create trigger function and trigger for automatic search vector updates
    - Create indexes for common queries
    - Add search function with filtering and sorting capabilities
  
  2. Indexes
    - GIN index on search_vector for fast full-text search
    - Composite index on category and material
    - Indexes on unit_price and bulk_price
*/
